...
| 項目 | URL |
|---|---|
| サポートURL | https://imasora.app/contact.html |
| マーケティングURL（任意） | https://imasora.app |
| プライバシーポリシーURL | https://imasora.app/privacy.html |
| 利用規約（EULA欄は空欄=標準EULAでOK。参考） | https://imasora.app/terms.html |
...
- [x] 初回起動時の利用規約同意
- [x] プライバシーポリシー等を公開済み（imasora.app）
- [x] スクリーンショット5枚（final/）
